import { MediaSettingsForm } from "@/app/(admin)/admin/settings/media/media-settings-form";
  ...
  return (
    <div className="grid gap-8">
      ...
      <div className="mx-auto w-full max-w-2xl">
        <MediaSettingsForm
          defaultTmdbApiKey={settings?.tmdbApiKey ?? ""}
          defaultMovieSource={settings?.movieSource ?? "tmdb"}
          defaultMusicSource={settings?.musicSource ?? "apple-music"}
        />
      </div>
    </div>
  );
